...
const Profile = () => {
  ...
  return (
    <>
      <SEO
        title="Profile Settings - AI Course Genesis"
        description="Manage your profile, preferences, and account settings for AI Course Genesis platform."
        keywords="user profile, account settings, preferences, theme settings, language settings"
      />
